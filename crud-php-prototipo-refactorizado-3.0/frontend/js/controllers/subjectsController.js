...
function setupSubjectFormHandler() 
{
  ...
  form.addEventListener('submit', async e => 
  {
        ...
        {
            // Mostrar error en alert y consola
...
{    try
    ...
    {
        // Mostrar error en alert y consola
        const error = "Error cargando materias: " + err.message;
        alert(error);
        console.error(error);
    }
}
...
{
    if (!confirm('¿Seguro que deseas borrar esta materia?')) return;    try
    {
    ...
    {
        // Mostrar error en alert y consola
        const error = "Error al borrar materia: " + err.message;
        alert(error);
        console.error(error);
    }
}
